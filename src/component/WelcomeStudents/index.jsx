              ...
              <div className="ecom-wc__form">
                <div className="ecom-wc__form-inner">
                  ...
                  <p className="ecom-wc__description text-muted mb-3">
                    <strong>{t("welcome_students.create_profile")}</strong> {t("welcome_students.or_explore")}
                  </p>
                  ...
                  <div className="ecom-wc__instructions bg-light p-3 rounded">
                    <h5 className="text-secondary">{t("welcome_students.additional_instructions")}</h5>
                    <ul className="list-style">
                      <li><i className="bi bi-check-circle text-success"></i> {t("welcome_students.instruction_one")}</li>
                      <li><i className="bi bi-check-circle text-success"></i> {t("welcome_students.instruction_two")}</li>
                    </ul>
                  </div>
                  <br />
                  {/* Welcome  */}
                          ...
                          <div className="ecom-wc__card-body text-center">
                            <div className="ecom-wc__button">
                              <a href="/page-1-personal-data" className="homec-btn complete-now">
                                <span>{t("welcome_students.complete_now")}</span>
                              </a>
                            </div>
