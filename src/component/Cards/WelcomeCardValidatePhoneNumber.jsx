...
function WelcomeCardValidatePhoneNumber({ languages, links, image, brunches, builtHouse }) {
  return (
...
WelcomeCardValidatePhoneNumber.propTypes = {
...
export default WelcomeCardValidatePhoneNumber;
