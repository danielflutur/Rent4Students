...
import RequestForOwner from "../Owners/RequestForOwner";

function DashboardPropertyCardOwner({
  status,
  image,
  why,
  title,
    ...
    <div className="homec-dashboard-property mg-top-30">
      ...
      <div className="homec-dashboard-property__img">
        ...
        <div className="homec-dashboard-property__content">
          {/* Badge vizual pentru solicitare activă */}
          {hasRequest && (
            <span 
              ...
              style={{
                ...
                backgroundColor: "#37C943", // O nuanță de galben-oranj
                color: "#fff",             // Text alb pentru contrast bun
                padding: "5px 10px",
                borderRadius: "4px"
              }}
            >
          ...
          {/* Logica pentru butonul din funcție de status */}
          <button
            type="button"
          ...
          >
            <span>
              {status === "Rented"
                ? "Vezi contractul de închiriere"
                : hasRequest
                ? "Vezi detaliile solicitării"
                : "Încă valabil pentru închiriere"}
            </span>
          </button>
...
DashboardPropertyCardOwner.propTypes = {
  ...
  hasRequest: PropTypes.bool, // Specifica că este opțională
};

DashboardPropertyCardOwner.defaultProps = {
  hasRequest: false,
};

export default DashboardPropertyCardOwner;
