...
function WelcomeCardValidatePhoneNumberOwner({ languages, links, image, brunches, builtHouse }) {
  return (
...
WelcomeCardValidatePhoneNumberOwner.propTypes = {
...
export default WelcomeCardValidatePhoneNumberOwner;
