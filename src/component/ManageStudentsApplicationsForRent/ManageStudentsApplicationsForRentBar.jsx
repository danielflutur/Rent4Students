...
function ManageStudentsApplicationsForRentBar({ gridStyle, handleGridStyle }) {
  return (
...
ManageStudentsApplicationsForRentBar.propTypes = {
  gridStyle: ProtoTypes.string.isRequired,
  handleGridStyle: ProtoTypes.func.isRequired,
};

export default ManageStudentsApplicationsForRentBar;
