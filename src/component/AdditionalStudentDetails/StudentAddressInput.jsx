...
function StudentAddressInput({ address, handleLocation }) {
  ...
  return (
    <div className="homec-submit-form mg-top-40">
      <h4 className="homec-submit-form__title">Adresa Dumneavoastră</h4>
...
export default StudentAddressInput;
