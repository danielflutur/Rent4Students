...
import FacultyBar from "./ManageStudentsBar";
import TableManageStudents from "../TableManageStudents";

function ManageStudentsGrid() {
  //handle grid style
...
export default ManageStudentsGrid;
